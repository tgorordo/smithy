...
coalitions within the set; in practice this often resolves cycles and is likely to result in a unique delegate (if they win all IRV tied elimination paths) which can claim a plurality coalition amongst the majority winners. (Depending on your elections and priorities it may be preferable to allow actual coalitions to form, reducing the field of candidates, and re-run the vote than to use this automatic resolution attempt).

This is a personal project - unless you want exactly what it provides, you should likely prefer to use more standard established software like [https://civs1.civs.us](https://civs1.civs.us).
